...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Docky', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '核动力驴', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sdq1217.vercel.app/', // 网站地址
  ...
  // 悬浮挂件
  WIDGET_PET: process.env.NEXT_PUBLIC_WIDGET_PET || falsh, // 是否显示宠物挂件
  WIDGET_PET_LINK:
        process.env.NEXT_PUBLIC_WIDGET_PET_LINK ||
        'https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  WIDGET_PET_SWITCH_THEME: process.env.NEXT_PUBLIC_WIDGET_PET_SWITCH_THEME || falsh, // 点击宠物挂件切换博客主题
